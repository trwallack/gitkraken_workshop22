...
# Square function
# adapted from GBCT Training group at HSPH (URL to be inserted later)
# and from R-Bloggers website (URL to be inserted later)
...
# Anscombe's quartet
# Exanokes from R-Bloggers website on visualized Ascomb's quartet
anscombes_quartet <- {
    library(Tmisc)
